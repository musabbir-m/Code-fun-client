        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="max-w-md">
            <h1 className="mb-5 text-5xl font-bold">
              Welcome to{" "}
              <span className="text-blue-800 decoraton-inherit">
                Code<span>Fun</span>{" "}
              </span>
            </h1>
            <p className="mb-5 text-xl">
              The emerging leaning platform for competetive programming. Codefun
              is recognized by the top tech-companies. Awarded one of the best
              beginner-friendly learning platform of 2022!{" "}
            </p>
